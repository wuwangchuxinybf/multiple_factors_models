...
data_pe = pd.read_csv(add_data+'internet_data/pe_ttm_120m.csv',index_col=0)
data_yield = pd.read_csv(add_data+'internet_data/yield_data_120m.csv',index_col=0)
data_float_a_shares = pd.read_csv(add_data+'internet_data/float_a_shares_120m.csv',index_col=0)
data_hs300 = pd.read_csv(add_data+'internet_data/hs300_120m.csv',index_col=0)
